...
const horarios = {
  ...
  jueves: [
    {clase: enum_clases.ESPALDA_SANA, inicio: "9:30"},
    {clase: enum_clases.MODELAJE, inicio: "11:00"},
    {clase: enum_clases.FUNCIONAL, inicio: "14:15"},
    {clase: enum_clases.ESPALDA_SANA, inicio: "17:00"},
    {clase: enum_clases.MODELAJE, inicio: "18:00"},
  ...
  viernes: [
    {clase: enum_clases.MODELAJE, inicio: "9:30"},
    {clase: enum_clases.MODELAJE, inicio: "11:00"},
    {clase: enum_clases.ESTIRAMIENTOS, inicio: "14:15"},
    {clase: enum_clases.NULL, inicio: "11:45"},
